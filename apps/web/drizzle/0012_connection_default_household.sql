...
-- Data fix for #74, before the trigger below exists: an account still
-- assigned to a household its connection's owner already left (or was
-- removed from) becomes unassigned, as it would have under the trigger.
